...
public class method_enter extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if ("慣行".equals(planet_method)) {
         if ("稻熱病".equals(result_name)) {
            result.setText("稻熱病");
            img.setImageResource(R.drawable.rice);
            describe.setText("本田部分：本病於第一期作較易發生。插秧後35～50天，田間如有葉稻熱病發生應即施藥一次，若經7天後繼續蔓延時再施藥一次。再於抽穗前7天左右及齊穗期各施藥一次，以預防穗稻熱病發生。");
            table1.setText("75% 三賽唑可溼性粉劑\n" +
                    "(tricyclazole)\n");
            table2.setText("FRAC 16.1;I1 系統性");
            ...
            describe.setText("1.第一次施藥時，應噴施於稻株葉鞘部，第二次、三次施藥時，應噴施於全株。\n" +
                    "2.第一期作，如發生本病時，亦須施藥。\n");
            table1.setText("500 g/L (50% w/v) 待普克利乳劑\n" +
                    "(difenoconazole + propiconazole)\n");
            table2.setText("FRAC 3;G1");
            ...
            table6.setText("1.採收前21天停止施藥。\n" +
             ...
             {Toast.makeText(getApplicationContext(), "跳轉出錯，請聯系工作團隊", Toast.LENGTH_SHORT).show();}
        }
        //有機農法
        else if ("有機".equals(planet_method)) {
            if ("稻熱病".equals(result_name)) {
                result.setText("稻熱病");
                img.setImageResource(R.drawable.rice);//有機
                describe.setText("1.通風不良或晨露不易消退的地區，不適合進行水稻有機栽培。\n"
                ...
                result.setText("胡麻葉枯病");
                img.setImageResource(R.drawable.brownspot);//有機
                describe.setText("1.水稻胡麻葉枯病較其他水稻病害略有不同的地方，在於田間缺乏氮、鉀、矽等元素容易發生，尤其是氮肥的管理，足量氮肥反而可抑制本病發生，與水稻其他病害如稻熱病、紋枯病、白葉枯病等相反，而鉀肥及矽酸肥則可增強抗病。因此，砂質壤土、泥炭土壤或土壤表層淺、土壤貧瘠田區，容易發生本病。\n" +
                ...
                result.setText("紋枯病");
                img.setImageResource(R.drawable.sheathblight);//有機
                describe.setText("1.有機質肥料應合理化施用，避免施用過量氮素含量高之有機質肥料。\n"
                ...
                result.setText("白葉枯病");
                img.setImageResource(R.drawable.bacterialleafblight);//有機
                describe.setText("1.施用矽酸爐渣或炭化稻殼等含矽資材，加強植株硬度，可以有效抵抗白葉枯病的侵害。\n" +
                ...
                result.setText("褐條葉枯病");
                img.setImageResource(R.drawable.narrowbrownleafspot);//有機
                describe.setText("1.有機質肥料應合理化施用，避免施用過量氮素含量高之有機質肥料。\n"
